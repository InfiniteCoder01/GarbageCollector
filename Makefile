...
Linker := -s ASYNCIFY -s WASM=1 -s MAX_WEBGL_VERSION=2 -s ALLOW_MEMORY_GROWTH=1 --bind --use-preload-plugins -O3 -flto=full
Settings := -o html/index.html --shell-file html/basic_template.html --preload-file Assets

html/index.html: $(ImGUI_OBJ) $(Mova_OBJ) Assets/*/* Assets/* Assets src/* Makefile
